...
* Configuración (líneas 15-17) del acceso a la nueva base de datos (`DATABASE_NAME`, `DATABASE_USER`
y `DATABASE_PASSWD`)
* Si se desea (líneas 21-23), se pueden modificar el nombre y contraseña de los usuarios que se van
